...
//sever management
$admin_mail = 'schoolworks@nate.com';


/// Database settings
$type     = 'mysql';                 // Type of database
$server   = 'localhost';             // Server the database is on
$db       = 'neohum801';             // Name of the database
...
$username = 'neohum801';         // Enter YOUR username here
...
$email_config = [
    ...
    'port'        => '587',
    'username'    => 'schoolworks',
    'password'    => 'sw1004!@',
    'security'    => 'tls',
    'admin_email' => 'schoolworks@nate.com',
    'debug'       => (DEV) ? 2 : 0,
];
