...
/* t-dashboard-upload.html */
class __TwigTemplate_2b144bd359964c7a3ed52c50b03a3306 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layout.html", "t-dashboard-upload.html", 1);
...
.list-section li.in-prog svg.tick{
    ...
    <div class=\"main-container\" id=\"container\">
        ...
        // line 267
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["doc_root"] ?? null), "html", null, true);
        yield "src/assets/img/logo.svg\" class=\"navbar-logo\" alt=\"logo\">
                            </a>
                        </div>
        ...
        yield "</span> 
                                ...
                                <div class=\"container\">
                                    <div class=\"header-section\">
                                        ...
                                        <p>첫 항목은 위에 있는 학급 번호 입니다. 학급번호를 확인해주세요</p>
                                        <p>만약, 동명이인이 있는 경우에는 이름 끝에 숫자를 넣어 구분해주세요</p>
                                        <p>예) 홍길동, 홍길동 => 홍길동, 홍길동2</p>
                                        <a href=\"";
        // line 456
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["doc_root"] ?? null), "html", null, true);
        yield "uloads/form.xlsx\" download>학생명단양식 다운로드</a>
                                    </div>
...
function typeValidation(type){
  ...
  if (type == 'application/pdf' || splitType == 'image' || splitType == 'video' || splitType == application / vnd.ms - excel || splitType == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' || splitType == 'application/vnd.ms-powerpoint' ||
    splitType == 'application/vnd.openxmlformats-officedocument.presentationml.presentation' || splitType == 'application/msword' || splitType == 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' || splitType == 'application/zip') {
        return true
    }
}
...
function uploadFile(file){
    ...
    http.open('POST', '../t-dashboard-sender', true)
    http.send(data)
...
";
    ...
    {
        return "t-dashboard-upload.html";
    }
    ...
    {
        return array (  619 => 537,  535 => 456,  515 => 439,  387 => 314,  368 => 298,  351 => 284,  331 => 267,  310 => 248,  303 => 244,  290 => 235,  284 => 233,  282 => 232,  51 => 3,  47 => 2,  36 => 1,);
    }
            ...
            <nav id=\"sidebar\">
                ...
                <div class=\"navbar-nav theme-brand flex-row  text-center\">
                    <div class=\"nav-logo\">
                        <div class=\"nav-item theme-logo\">
                            <a href=\"/\">
                                <img src=\"{{ doc_root }}src/assets/img/logo.svg\" class=\"navbar-logo\" alt=\"logo\">
                            </a>
                        </div>
                        <div class=\"nav-item theme-text\">
                            <a href=\"/\" class=\"nav-link\"> CORK </a>
                        ...
                        <li class=\"nav-item more-dropdown\">
                            <div class=\"nav-item more-dropdown ml-200 mb-20\">
                              <a class=\"dropdown-toggle btn\" role=\"button\" id=\"className\" >
                                ...
                                =>
                                <a class=\"dropdown-toggle btn btn-primary\"  role=\"button\" id=\"customDropdown\" data-bs-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">
                                            <span>2.학생 일괄 업로드하기: 학급번호 {{ className }}</span> 
                                </a>
                                ...
                                <div class=\"container\">
                                    <div class=\"header-section\">
                                        ...
                                        <p>만약, 동명이인이 있는 경우에는 이름 끝에 숫자를 넣어 구분해주세요</p>
                                        <p>예) 홍길동, 홍길동 => 홍길동, 홍길동2</p>
                                        <a href=\"{{doc_root}}uloads/form.xlsx\" download>학생명단양식 다운로드</a>
                                    </div>
                                    <div class=\"drop-section\">
                                        <div class=\"col\">
                                            <div class=\"cloud-icon\">
...
{% endblock %}", "t-dashboard-upload.html", "/Users/nm/works/project/fbc/templates/t-dashboard-upload.html");
    }
}
