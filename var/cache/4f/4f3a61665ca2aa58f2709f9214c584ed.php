...
.list-section li.in-prog svg.tick{
    ...
    <div class=\"main-container\" id=\"container\">
        ...
        // line 449
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["doc_root"] ?? null), "html", null, true);
        yield "t-dashboard-upload/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["className5"] ?? null), "html", null, true);
        yield "\" method=\"post\">
        ...
        yield "\" readonly />
                                ...
                                <div class=\"container\">
                                    <div class=\"header-section\">
                                        ...
                                        <a href=\"../uloads/form.xlsx\" download>학생명단양식 다운로드</a>
                                    </div>
...
";
    ...
    {
        return array (  629 => 551,  527 => 452,  519 => 449,  379 => 312,  360 => 296,  308 => 246,  301 => 242,  288 => 233,  282 => 231,  280 => 230,  51 => 3,  47 => 2,  36 => 1,);
    }
                                    ...
                                    <div class=\"modal-dialog\" >
                                      <div class=\"modal-content\" style=\"background-color:white;\">
                                        <div class=\"modal-header\">
                                         ...
                                         <form action=\"{{ doc_root }}t-dashboard-upload/{{ className5 }}\" method=\"post\">
                                        <div class=\"modal-body\">
                                        
                                            <input type=\"text\" class=\"form-control\" id=\"className\" name=\"className\" value=\"{{ className4 }}\" readonly />
